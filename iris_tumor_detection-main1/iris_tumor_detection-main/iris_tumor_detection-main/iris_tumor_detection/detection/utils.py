...
model_path = r'C:\Users\ELCOT\Downloads\iris_tumor_detection-main1\iris_tumor_detection-main\iris_tumor_detection-main\iris_tumor_detection\detection\iris_tumor_model_vgg16.keras'  # Update path if necessary
